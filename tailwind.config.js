...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        sans: ['"Anek Devanagari"', 'Montserrat', 'ui-sans-serif', 'system-ui'],
        serif: ['ui-serif', 'Georgia'],
        mono: ['ui-monospace', 'SFMono-Regular'],
        // You can also add specific keys if you want:
      ...
      backgroundImage: {
        ...
        'custom-gradient-dark': 'linear-gradient(137.45deg, #24262d, #1A1A1A)',
      },
      container: {
        center: true,
      },
  ...
  plugins: [
    ...
    plugin(function ({ addBase, matchUtilities }) {
      addBase({
        // Default colors
        ":root": {
          "--color-theme-1": toRGB("#d6ac08"),
          "--color-theme-2": toRGB("#212529"),
          "--color-primary": toRGB("#D6AC08FF"),
          ...
          "&.dark": {
            "--color-theme-1": toRGB("#01324e"),
            "--color-theme-2": toRGB("#D6AC08FF"),
            "--color-primary": toRGB("#0c1820"),
          },
        },
        ...
        // Theme 1 colors
        ".theme-1": {
          "--color-theme-1": toRGB("#0d1721"),
          "--color-theme-2": toRGB("#0d1721"),
          "--color-primary": toRGB("#0d1721"),
          "--color-secondary": toRGB("#0d1721"),
          "--color-success": toRGB(colors.teal["600"]),
          "--color-info": toRGB(colors.cyan["600"]),
          "--color-warning": toRGB(colors.yellow["600"]),
          "--color-pending": toRGB(colors.orange["700"]),
