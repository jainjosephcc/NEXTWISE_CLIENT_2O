...
<template>
  <div class="grid grid-cols-12 gap-y-10 gap-x-6">
    <div class="col-span-12">
      ...
      <div class="relative mt-16 flex flex-col col-span-12 lg:col-span-8 xl:col-span-7 gap-y-7">
        <div class="flex flex-col p-5 box box--stacked">
          <div
            class="bg-white dark:bg-gray-800 rounded-md p-4 mb-3 border-b border-dashed flex flex-col lg:flex-row gap-10">
            <!-- Feed Mode Dropdown -->
            <div>
              <label for="feedMode" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Feed</label>
              <FormSelect id="feedMode" v-model="selectedFeedMode" class="sm:mt-2 sm:mr-2">
            ...
            <div v-if="selectedFeedMode === 'market'">
              <label for="market" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Market</label>
              <FormSelect id="market" v-model="selectedMarket" class="sm:mt-2 sm:mr-2">
            ...
            <div v-if="selectedFeedMode === 'symbol'">
              ...
              <FormSelect id="symbol" v-model="selectedSymbol" class="sm:mt-2 sm:mr-2">
          ...
          <!-- TradingView Widget -->
          <div class="tradingview-widget-container rounded-lg p-4 border-0" style="border: 0px !important;">
            <div class="iframe-overlay"></div>
            <div class="tradingview-widget-container__widget border-0" style="border: 0px !important;"></div>
            <div class="tradingview-widget-copyright border-0" style="border: 0px !important;">
